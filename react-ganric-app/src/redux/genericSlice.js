...
export function createResourceSlice(resourceName, apiUrl) {
  // Async actions
  ...
  const addResource = createAsyncThunk(`${resourceName}/add`, async (item) => {
    const response = await axios.post(apiUrl, item);
    return response.data;
  });

  const updateResource = createAsyncThunk(`${resourceName}/update`, async ({ id, item }) => {
